                 ...
                 <div class="alert alert-warning alert-dismissible" role="alert" id="errMsgContiner">
                  ...
                  <div class="space-6"></div>
                      ...
                      <div class="clearfix">
                        ...
                        <a href="loginController.do?goRegister" class="btn btn-link">注册账号</a>
                        <a href="loginController.do?goResetPwdMail" class="btn btn-link">忘记密码 ?</a>
                          <button type="button" id="but_login"  onclick="checkUser()" class="width-35 btn btn-sm btn-primary" style="left: 33%">
